...
export class MedicamentService {
  ...
  async chargerDonneesInitiales() {
    ...
    const baseMedicaments = [
      ...
      // --- PARASITOLOGIE & INTESTIN (DÉPARASITAGE) ---
      ...
      { codeCip: "34010102", nomCommercial: "FLUVERMAL", dci: "Flubendazole", dosage: "100 mg", forme: "Comprimé", prixReference: 1500, surOrdonnance: false, categorie: "Antiparasitaire" },
      ...
      { codeCip: "34009607", nomCommercial: "DUPHALAC", dci: "Lactulose", dosage: "66.5%", forme: "Solution buvable", prixReference: 3200, surOrdonnance: false, categorie: "Laxatif" },
      ...
      { codeCip: "34009705", nomCommercial: "CELESTENE", dci: "Bétaméthasone", dosage: "2 mg", forme: "Comprimé dispersible", prixReference: 2100, surOrdonnance: true, categorie: "Anti-inflammatoire" },
      ...
      { codeCip: "34010402", nomCommercial: "KAMAGRA (GÉNÉRIQUE)", dci: "Sildénafil", dosage: "100 mg", forme: "Gel oral", prixReference: 2500, surOrdonnance: false, categorie: "Santé Sexuelle" },

      // --- VITAMINES, MINÉRAUX & TONUS ---
      ...
      { codeCip: "34009808", nomCommercial: "JUVAMINE", dci: "Multivitamines", dosage: "Gold", forme: "Comprimé", prixReference: 3500, surOrdonnance: false, categorie: "Vitamine" },
